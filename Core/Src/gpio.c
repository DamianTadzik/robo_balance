...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, DIR_L_2_Pin|DIR_L_1_Pin|DIR_R_1_Pin|DIR_R_2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LD3_GPIO_Port, LD3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PAPin PAPin PAPin PAPin */
  GPIO_InitStruct.Pin = DIR_L_2_Pin|DIR_L_1_Pin|DIR_R_1_Pin|DIR_R_2_Pin;
